    ...
    <x-jet-dialog-modal wire:model="open_modalComentario">
        ...
        <x-slot name="content">
            <div class="mb-4 text-left">
                <x-jet-label value="Alumno" class=""/>
                <input type="text" class="w-full form-control" value="{{ $alumnoUnidad->matricula->alumno->user->name }}" disabled>
            </div>
            <div class="mb-4 text-left">
